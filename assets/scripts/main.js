...
$(".js-footer").click(function(e) {
  if(navOpen) {
    ...
    $('.floating-nav').removeClass('opacity-100 bottom-26 max-h-full');
    $('.js-nav-arrow ').removeClass('rotate-180');
    navOpen = false;
  } else {
    $('.floating-nav').removeClass('max-h-0 opacity-0 bottom-10');
    $('.floating-nav').addClass('opacity-100 bottom-26 max-h-full');
...
$(document).scroll(function() {
  ...
  if(docScroll > 80) {
    ...
    $('.js-footer').addClass('opacity-100 bottom-6');
  } else {
    $('.js-footer').addClass('opacity-0 -bottom-10');
    $('.js-footer').removeClass('opacity-100 bottom-6');
    $('.floating-nav').addClass('max-h-0 opacity-0 bottom-10');
    $('.floating-nav').removeClass('opacity-100 bottom-26 max-h-full');
    $('.js-nav-arrow ').removeClass('rotate-180');
    navOpen = false;
